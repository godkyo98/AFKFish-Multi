...
import Kyo.autofish.Autofish; // Gọi Common Singleton
...
public class AutofishScheduler {
    ...
    // Constructor không cần tham số nữa
    ...
    public void tick(Minecraft client) {
        ...
        // Needed because Util.getMillis() can return a different value when the game is first initializing
        ...
        // SỬA ĐỔI: Lấy config từ Singleton
        if (!Autofish.getInstance().getConfigManager().getConfig().isAutofishEnabled()) {
            queuedActions.clear();
        }
